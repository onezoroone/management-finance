                    ...
                    <div className="max-w-[460px] m-auto pt-24 pb-16">
                        ...
                        <div className="relative mt-6 mb-5">
                            ...
                            <div className="relative flex justify-center text-sm">
                                <span className="bg-white px-2 text-base text-bgray-600">Hoặc tiếp tục với</span>
                            </div>
                        </div>
                        <form onSubmit={onSubmit}>
                            <div className="flex flex-col md:flex-row gap-4 justify-between mb-4">
                                <div>
                                    <input type="text" className="text-bgray-800 text-base border border-bgray-300 h-14 w-full focus:border-success-300 focus:outline-none focus:ring-0 rounded-lg px-4 py-3.5 placeholder:text-bgray-500 placeholder:text-base " placeholder="Họ" value={input.firstName} onChange={handleChange} name="firstName" />
                                </div>
                                <div>
                                    <input type="text" className="text-bgray-800 text-base border border-bgray-300 h-14 w-full focus:border-success-300 focus:outline-none focus:ring-0 rounded-lg px-4 py-3.5 placeholder:text-bgray-500 placeholder:text-base" placeholder="Tên" value={input.lastName} onChange={handleChange} name="lastName" />
                                </div>
                            </div>
                            <div className="mb-4">
                                <input type="text" className="text-bgray-800 text-base border border-bgray-300 h-14 w-full focus:border-success-300 focus:outline-none focus:ring-0 rounded-lg px-4 py-3.5 placeholder:text-bgray-500 placeholder:text-base" placeholder="Email" value={input.email} onChange={handleChange} name="email" />
                            </div>
                            <div className="mb-6 relative">
                                <input type="password" className="text-bgray-800 text-base border border-bgray-300 h-14 w-full focus:outline-none focus:border-success-300 focus:ring-0 rounded-lg px-4 py-3.5 placeholder:text-bgray-500 placeholder:text-base" placeholder="Mật khẩu" value={input.password} onChange={handleChange} name="password" />
                            ...
                            <div className="mb-6 relative">
                                <input type="password" className="text-bgray-800 text-base border border-bgray-300 h-14 w-full focus:outline-none focus:border-success-300 focus:ring-0 rounded-lg px-4 py-3.5 placeholder:text-bgray-500 placeholder:text-base" placeholder="Nhập lại mật khẩu" value={input.confirmPassword} onChange={handleChange} name="confirmPassword" />
                                <button type="button" className="absolute top-4 right-4 bottom-4">
                                <svg width="22" height="20" viewBox="0 0 22 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M2 1L20 19" stroke="#718096" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
                                    <path d="M9.58445 8.58704C9.20917 8.96205 8.99823 9.47079 8.99805 10.0013C8.99786 10.5319 9.20844 11.0408 9.58345 11.416C9.95847 11.7913 10.4672 12.0023 10.9977 12.0024C11.5283 12.0026 12.0372 11.7921 12.4125 11.417" stroke="#718096" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
                            ...
                            <div className="flex justify-between mb-7">
                                ...
                                <input type="checkbox" className="w-5 h-5 focus:ring-transparent rounded-md border border-bgray-300 focus:accent-success-300 text-success-300 dark:bg-transparent dark:border-darkblack-400" name="remember" id="remember" />
                                    <label htmlFor="remember" className="text-bgray-600 text-base">Bằng cách nhấp vào đây bạn đồng ý với <span className="text-bgray-900">Điều khoản dịch vụ,</span> <span className="text-bgray-900">Chính sách bảo mật,</span> và <span className="text-bgray-900">Chính sách truyền thông điện tử</span>.</label>
                                </div>
                            </div>
                        ...
                        Bạn đã có tài khoản? <Link href="/" className="font-semibold underline">Đăng Nhập</Link>
                        </p>
